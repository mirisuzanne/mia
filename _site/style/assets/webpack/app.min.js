      ...
      !(function(e) {
        ...
        (function(e) {
          ...
          function h(e, n, t, i) {
              ...
              (v +=
                null != w.subLanguage
                  ? (function() {
                      ...
                      if (e && !a[w.subLanguage]) return d(y);
                      var n = e
                  ...
                  : (function() {
                      var e, n, t, a;
                      if (!w.keywords) return d(y);
                      (a = ''),
                        (n = 0),
                        (w.lexemesRe.lastIndex = 0),
                        (t = w.lexemesRe.exec(y));
                      for (; t; )
                        (a += d(y.substring(n, t.index))),
                          (e = r(w, t))
                            ? ((x += e[1]), (a += s(e[0], d(t[0]))))
                            : (a += d(t[0])),
            ...
            function g(e) {
              (v += e.className ? s(e.className, '', !0) : ''),
                (w = Object.create(e, { parent: { value: w } }));
            }
            function m(e, n) {
              if (((y += e), null == n)) return o(), 0;
              var a = (function(e, n) {
                var t, a;
                  ...
                  if (u(n.contains[t].beginRe, e))
                    return (
                      n.contains[t].endSameAsBegin &&
                        (n.contains[t].endRe = ((i = n.contains[t].beginRe.exec(
                          e,
                        )[0]),
                        new RegExp(
                          i.replace(/[-\/\\^$*+?.()|[\]{}]/g, '\\$&'),
          ...
          r = function() {
            ...
            n.on('target:open', '[data-toggle="target"]', function(n) {
              ...
              n.on('click', '[data-toggle="close"]', function(n) {
                n.preventDefault();
                var a = e(
                  '[data-target-id="'.concat(
                    e(this).attr('aria-controls'),
                    '"]',
                  ),
                );
                t(a);
